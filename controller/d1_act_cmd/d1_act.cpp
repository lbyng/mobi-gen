...
void Handler(const void* msg)
{
    ...
    try {
        ...
        std::cerr << "Error processing feedback data: " << e.what() << std::endl;
    }
}
...
{   
    ...
    std::cout << "ZeroMQ publisher binds to tcp://*:5556" << std::endl;
    
    ChannelFactory::Instance()->Init(0);
    ChannelSubscriber<unitree_arm::msg::dds_::ArmString_> subscriber(TOPIC1);
    subscriber.InitChannel(Handler);
    
    std::cout << "Listen to Unitree robot feedback and publish joint positions via ZeroMQ..." << std::endl;
